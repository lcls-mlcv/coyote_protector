...
# ---------- Paths (edit these) ----------
weights_path = '/sdf/home/p/pmonteil/prjlumine22/results/pmonteil/coyote_beamtime_19jan/weight_yolov11n_150epochs.pt'         # trained weights
mag_factor = 1 #magnification factor (i.e the zoom of the optics used)
px_size = 0.5 #pixel size
px_to_um = px_size/mag_factor                 # pixel -> micron conversion
alert_um = 100.0                              # threshold for alert

# ---------------------------------------

chip_pic_dir = 'images'        # folder of images to test
...
results = model.predict(
    ...
    save=False,             # YOLO draws/saves annotated images
    verbose=True
)
