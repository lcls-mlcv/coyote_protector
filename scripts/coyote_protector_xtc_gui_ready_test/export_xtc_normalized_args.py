...
print(f"[CONFIG] exp={exp} run={run_number} save_normalized={SAVE_NORMALIZED} max_events={max_events}")
...
#ds = DataSource(exp='mfx101346325', run=59, max_events=100)
