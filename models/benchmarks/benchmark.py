...
def run_accuracy_benchmark():
    ...
    for cfg in MODELS:
        ...
        # Disable val plotting to avoid class-name plotting KeyError on some dataset/model combos.
        # Limit workers to match cluster recommendation and prevent dataloader warnings/freezes.
        results = model.val(data=DATA_YAML, plots=False, workers=2)
